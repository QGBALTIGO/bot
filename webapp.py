...
<title>Source Baltigo</title>
<style>
body{
margin:0;
font-family:system-ui;
background:linear-gradient(180deg,#050a14,#0d1a2e);
color:white;
display:flex;
align-items:center;
...
.card:hover{transform:scale(1.05);background:#152746}
</style>
</head>
<body>
<div class="wrap">
<h1>📚 Source Baltigo</h1>
<div class="grid">
<div class="card" onclick="location.href='/anime'">🎬 Anime</div>
<div class="card" onclick="location.href='/mangas'">📖 Mangá</div>
</div>
</div>
</body>
</html>
