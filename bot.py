...
# ==================================================
# 20) /dado + /colecao + /nomecolecao (POSTGRES) — FIX TOTAL
# (GIROS SLOT 01/04/07/10/13/16/19/22 + CAP 24)
# (ANTI-SPAM await + PROCESSING STATE + RETRY + FALLBACK + CACHE)
# ==================================================

# ✅ GARANTA ESTES IMPORTS NO TOPO DO bot.py
