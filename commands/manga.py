...
async def manga(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton("📚 Abrir Catálogo de Mangás", web_app=WebAppInfo(url=url))]])
    if msg:
        await msg.reply_photo(photo=MANGA_BANNER_URL, caption=texto, parse_mode="HTML", reply_markup=kb)
