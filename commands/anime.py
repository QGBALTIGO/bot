...
async def anime(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if _is_group(update):
        ...
        teclado = InlineKeyboardMarkup([[InlineKeyboardButton("📺 Abrir Catálogo no privado", url=f"https://t.me/{BOT_USERNAME}")]])
        if update.message:
    ...
    if update.message:
        await update.message.reply_photo(photo=CATALOG_BANNER_URL, caption=texto, parse_mode="HTML", reply_markup=teclado)
